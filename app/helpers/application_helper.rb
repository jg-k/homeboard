module ApplicationHelper
  ...
  def icon(name, size: nil, css_class: nil)
    paths = {
      ...
      archive: '<polyline stroke-width="2" stroke-linecap="round" stroke-linejoin="round" points="21 8 21 21 3 21 3 8"/><rect x="1" y="3" width="22" height="5" rx="1" stroke-width="2" stroke-linejoin="round"/><line x1="10" y1="12" x2="14" y2="12" stroke-width="2" stroke-linecap="round"/>',
